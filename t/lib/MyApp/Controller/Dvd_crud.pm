package MyApp::Controller::Dvd_crud;
use Moose;
use MooseX::MethodAttributes;

extends 'WebNano::CRUDController';

has record_controller_class => ( is => 'ro', isa => 'Str', default => 'MyApp::Controller::Dvd_crud::Record' );
has form_class => ( is => 'ro', isa => 'Str', default => 'CRUDDvdForm' );
has rs_name => ( is => 'ro', isa => 'Str', default => 'Dvd' );

package MyApp::Controller::Dvd_crud::Record;
use Moose;
use MooseX::MethodAttributes;

extends 'WebNano::CRUDController::Record';
